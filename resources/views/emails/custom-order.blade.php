    ...
    <tr>
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" style="width:100%!important">
                ...
                <tr>
                    <td style="padding:20px;font-size:14px;">Hi Admin,<br/>{!! $name !!} submit an order enquiry on website.</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding:5px 20px;line-height:20px;color:#626262">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td width="50%" style="color:#626262;font-size:14px;vertical-align:top;line-height:20px;padding:5px">Product: </td>
                                    <td width="50%" style="color:#222222;font-size:14px;vertical-align:top;line-height:20px;padding:5px">{!! $product_name !!}</td>
                                </tr>
                                <tr>
